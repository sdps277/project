...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    <ul class="nospace center clear">    
     <li class="one_third first"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/12.jpg" alt=""></a>
        <h6 class="push10">Ernie ball Music Man Series</h6>
      </li>
      <li class="one_third"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/5.jpg" alt=""></a>
        <h6 class="push10">Duncan Signature Pickups</h6>
      </li>
      <li class="one_third"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/3.jpg" alt=""></a>
        <h6 class="push10">56mm Plectrum</h6>
        </li>
       <li class="one_third first"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/9.jpg" alt=""></a>
        <h6 class="push10">Boss Pedal Series</h6>
      </li>
      <li class="one_third"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/10.jpg" alt=""></a>
        <h6 class="push10">Gibson Guitar Series</h6>
      </li>
      <li class="one_third"><a href="#"><img class="circle pad5 borderedbox push30" src="../images/demo/gallery/8.jpg" alt=""></a>
        <h6 class="push10">Marshall Guitar Amplifiers</h6>
      </li>
    </ul>
    <div class="clear"></div>
  </main>
