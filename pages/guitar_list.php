...
<div class="wrapper row3">
  <main id="container" class="clear"> 
   <div class="sidebar one_quarter first"> 
        ...
        Your Guitar Cart is at the bottom. Add items to your guitar cart.
      </nav>
    </div>
 <div id="content" class="three_quarter"> 
      ...
      ?>          
          <tr><td colspan="3"><?php echo "<i>Your guitar cart is empty."; ?></td></tr>
            <?php
        }
      ?>    
        <tr><td colspan="3"><a href="guitar_list.php?page=cart">Go To Guitar Cart</a></td></tr>
        <?php
        }else{
    ?>
