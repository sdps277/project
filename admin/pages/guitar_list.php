  ...
  <main id="container" class="clear"> 
    <div class="sidebar one_quarter first"> 
      <nav class="sdb_holder">
        <ul>
          <li><a href="add_guitar.php">Add Guitar</a></li>
        </ul>
</nav>
</div>
 <div id="content" class="three_quarter"> 
   <h3>Available guitars in the Store</h3>
  <?php
...
<img src="../../images/<?php echo $image_name; ?>" width="70px" height="70px"></br>
 ...
 <a href="update_guitar.php?edit=<?php echo $id;?>">Update</a> |
<a href="delete_guitar.php?del=<?php echo $id;?>">Delete</a></td></br>
</tr>
<?php } ?>
</table>
</div>
